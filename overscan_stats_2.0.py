        ...
        for filename in os.listdir(folder_path):
            if filename.endswith('.fits'):
                ...
                with fits.open(file_path) as hdul:
                    ...
                    overscan_data,over_high,over_low = sigmaclip(overscan_data,3,3)
...
output_csv = r"C:/OneDrive - Arizona State University/SPARCS Documents/Logan Working/Phase2/Data/gpt_darkandbias_overscan2.1/combined_overscan_statistics_sigclip.csv"  # Specify your desired output file name
