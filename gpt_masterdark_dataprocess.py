...
for img in glob.glob(pattern):
    ...
    image_reg = data[100:1033-8,10:10+1056]
    # image_reg = data[500:510,500:510]
    
    #sigma clip both regions to remove outliers
    overscan_clip,over_high,over_low = stats.sigmaclip(overscan_reg,3,3)
...
filename = r"C:\OneDrive - Arizona State University\SPARCS Documents\Logan Working\Phase2\Data\gpt_darkandbias_overscan2.1\dark_test.csv"
df.to_csv(filename)