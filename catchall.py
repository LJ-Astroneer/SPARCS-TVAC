...
plt.yscale('log')
plt.title('Partial Pressures for selected species over time')
...
plt.title('Chamber pressure over time with bakeouts removed')
plt.ylabel('Total chamber pressure (log Torr)')
